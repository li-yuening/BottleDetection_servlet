...
/**
 * Servlet implementation class NoneDestructiveDetect
 */
public class NoneDestructiveDetect extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoneDestructiveDetect() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		list=ud.executeNoneDestructiveDetectWaitedBottleQuery();
